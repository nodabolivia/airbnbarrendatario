      ...
      this.route.queryParams.subscribe(() =>{
        if(this.router.getCurrentNavigation().extras.state){
          if(this.router.getCurrentNavigation().extras.state.placeId){
            this.placeId =this.router.getCurrentNavigation().extras.state.placeId;
            console.log(this.placeId);
            this.getPlace();
          }
          if(this.router.getCurrentNavigation().extras.state.pickupLocation){
            this.coords = this.router.getCurrentNavigation().extras.state.pickupLocation;
          }
  ...
  getPlace() {
    this.apiService.getPlace(this.placeId).subscribe((response) => {
      if (response.res === 'success') {
        ...
        this.formPlace.get('descripcion').setValue(objPlaceResponse.descripcion);
        this.formPlace.get('cantPersonas').setValue(objPlaceResponse.cantPersonas);
        ...
        this.formPlace.get('cantHabitaciones').setValue(objPlaceResponse.cantHabitaciones);
        this.formPlace.get('tieneWifi').setValue(objPlaceResponse.tieneWifi);
        this.formPlace.get('cantVehiculosParqueo').setValue(objPlaceResponse.cantVehiculosParqueo);
        this.formPlace.get('precioNoche').setValue(objPlaceResponse.precioNoche);
        this.formPlace.get('costoLimpieza').setValue(objPlaceResponse.costoLimpieza);
